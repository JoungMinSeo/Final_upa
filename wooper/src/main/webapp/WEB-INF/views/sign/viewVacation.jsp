                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;">
                            	<c:choose>
                                	<c:when test='${document.vacationType == "0"}'>
                                		휴가
                                	</c:when>
                                	<c:when test='${document.vacationType == "1"}'>
                                		연차
                                	</c:when>
                                	<c:when test='${document.vacationType == "2"}'>
                                		병가
                                	</c:when>
                                </c:choose>
                            </td>
                        ...
                        <tr>
                            <th>휴가 기간</th>
                            <td style="text-align: left;">
                                ${document.vacationStartDt}  ~  ${document.vacationEndDt}
                            </td>
                        </tr>
                        <tr>
                            <th>휴가 사유</th>
                            <td>${document.vacationReason}</td>
                        </tr>
                        <tr>
                            <th>기타 사항</th>
