...
<head>
	...
	.searchList:hover, .searchList2:hover{
		cursor : pointer;
	}
...
<body>
    <div class="expense-report-container">
        ...
        <form action="signLine" method="POST">
                ...
                <div class="expense-report-writeInfo">
                    <table class="table table-sm">
                        <tbody>
                            ...
                            <tr>
                                <th>기안일</th>
                                <td>${document.signDraftingDt}</td>
                            </tr>
                            <tr>
                                <th>요청 부서</th>
                                <td>${document.expenseDept}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="expense-report-content">
                <table class="table table-sm" id="expense-report-content-info">
                    <tbody>
                        ...
                        <tr>
                            <th>거래처 번호</th>
                            <td width="380px">${document.accountPhone}</td>
                            <th width="120px">거래 일자</th>
                            <td width="380px">${document.accountDt}</td>
                        </tr>
                        <tr>
                            <th>납품 요청 기한</th>
                            <td>${document.deliveryStartDt} ~ ${document.deliveryEndDt}</td>
                            <th>지불 방법</th>
                ...
                <table class="table table-sm" id="expense-report-content-table">
                    <tbody>
                        ...
                        <fmt:parseNumber var="sum" value="0"/>
                        <c:forEach items="${document.pList}" var="item" varStatus="vs" >
	                        ...
	                        <fmt:parseNumber var="totalPrice" value="${item.totalPrice}"/>
	                        <fmt:parseNumber var="sum" value="${sum + totalPrice  }"/>
                    ...
                    <tfoot>
                        <tr>
                            <th colspan="5">합계</th>
                            <td><div id="sum" style="text-align: right;">${sum}</div></td>
                            <td width="80px">VAT 별도</td>
                        </tr>
                    </tfoot>
                </table>
                <table class="table table-sm">
