...
<body>
    ...
    <div class="p-6">
        <img id="logo" src="${pageContext.request.contextPath}/resources/img/noneLogo.png">
        <h2>회원 가입</h2>
		...
		<div class="row">
				<form method="POST" action="signUp" class="needs-validation" name="signUpForm">
					<div class="col form-col">
						...
						<div class="col-md">
                            <input type="text" class="form-control" name="memberId" id="id" placeholder="아이디는 이메일 형식으로 입력해주세요." autocomplete="off" required>
						</div>
					...
					<div class="col form-col">
						...
						<div class="col-md">
							<input type="password" class="form-control" id="pwd1" name="memberPw" maxlength="20" placeholder="비밀번호를 입력해주세요." required>
						</div>
					...
					<div class="col form-col">
						...
						<div class="col-md">
							<input type="password" class="form-control" id="pwd2" maxlength="20" placeholder="비밀번호를 입력해주세요." required>
						</div>
					...
					<div class="col mb-3 form-row">
                        ...
                        <button class="btn" type="button" id="btn">인증</button>
					</div>
