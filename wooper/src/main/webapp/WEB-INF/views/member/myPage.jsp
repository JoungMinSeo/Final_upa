    ...
    <div>
        <div class="bg-white rounded shadow-sm container p-2" id="content">
            <form action="update" method="POST">
                <div class="img-class">
                    <img src="img/user.png" id="img" onclick="document.all.file.click()" onchange="LoadImg">
                    <input type="file" id="file" name="file" style="display:none;" onchange="LoadImg(this,0)">
                </div> <br>
                <div class="area">
