...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/secession.css">
<body>
	<div id="include">
		...
		<div class="container" id="content-main">
			...
			<div class="row my-5">
				<div class="col-sm-offset-2 col-sm-8">
					<div class="bg-white rounded shadow-sm container p-5 secession">
						<h4>회원 탈퇴</h4>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="form-group pull-left">
										...
										<div class="col-xs-12">
											<textarea class="form-control" readonly rows="18" cols="100">
탈퇴 약관
										...
										<div class="checkbox pull-right">
											...
											<br>
												<div class="row mb-3 form-row">
													<div class="col-md-3">비밀번호 입력</div>
													<div class="col-md-6">
												...
												<div class="form-check">
													<input type="checkbox" name="agree" id="agree"
														...
														class="form-check-label custom-control-label" for="agree">정말
														탈퇴하시겠습니까?</label>
												</div>
											</div>
										</div>
